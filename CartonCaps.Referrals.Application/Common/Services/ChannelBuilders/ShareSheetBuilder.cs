...
{
    public class ShareSheetBuilder : IReferralChannelMessageBuilder
    {
        public ShareChannel Channel => ShareChannel.ShareSheet;

        private readonly ReferralShareOptions _options;
        public ShareSheetBuilder(IOptions<ReferralShareOptions> options)
        {
